"""
Django settings for mute_forest_dev_100249 project.
...
ROOT_URLCONF = 'mute_forest_dev_100249.urls'
...
WSGI_APPLICATION = 'mute_forest_dev_100249.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mute_forest_dev_100249 API",
    "DESCRIPTION": "API documentation for mute_forest_dev_100249 App",
    "VERSION": "v1",
}
